...
def generate_all_node_pair_adj(node_num,edge_index,node_label,node_label_num,adj):
    ...
    ntype_label_for_each_pair = torch.cat((row,col),dim=2)
    ntype_label_for_each_pair = node_label[ntype_label_for_each_pair]
    ...
    return all_node_pair_label,max_np_label
...
## TODO generate accurate np label for no edged node pairs
...
if __name__ == "__main__":
    ...
    #         i+=1
    node_pair_label,max_np_label = generate_all_node_pair_adj(5,edge_index,node_label,3,g.adjacency_matrix())
